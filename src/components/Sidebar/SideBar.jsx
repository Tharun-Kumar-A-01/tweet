...
const SideBar = () => {
	...
	return (
		<>
			...
			<div className="border-r border-white hidden sm:flex sm:w-1/4 md:w-1/6 bg-gray-950 text-white pt-10 h-full fixed flex-col justify-between items-center">
				<div className="flex w-full flex-col gap-10 items-center">
					<Link href="/">
						<h1 className="font-bold hidden sm:inline-block text-3xl ">
							TWEET
						</h1>
					</Link>
				</div>
				<div className="flex flex-col w-fit gap-2 items-center mb-3">
					{session ? (
						<Link href="/profile">
							<button
								className={`${spaceGrotesk.className} p-4 py-2 bg-primary rounded-full text-black font-bold`}
							>
								PROFILE
							</button>
						</Link>
						...
						<>
							<Link href="/login">
								<button
									className={`${spaceGrotesk.className} p-6 py-2 bg-primary rounded-full w-max text-black font-bold`}
								>
									LOG IN
								</button>
							</Link>
			...
			<div className="border-b border-white w-full sm:hidden bg-gray-950 text-white h-16 px-5 fixed flex flex-row justify-between items-center">
				<Link href="/">
